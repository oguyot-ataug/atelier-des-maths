...
function adminApplyScopeUI(){
  ...
  if(tHint) tHint.innerHTML = scoped
    ? ((etab && etab.site_key_allowed)
        ? "Pour chaque collègue, choisissez qui paie son IA (et celle de ses élèves) : <b>la clé du site</b> (accès accordé à votre établissement par l'administrateur général, dans la limite de son budget mensuel), <b>la clé de l'établissement</b> (ci-dessus) ou <b>sa clé personnelle</b>. Le choix s'applique immédiatement ; chacun active ensuite lui-même l'IA dans sa page. Une clé personnelle enregistrée sert aussi de <b>clé de secours</b> : elle prend le relais automatiquement si la clé prévue n'est plus utilisable (budget atteint, clé absente ou sans crédit)."
