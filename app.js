...
document.querySelectorAll('[data-nav]').forEach(el=>{
  el.addEventListener('click',(e)=>{
    ...
    if(nav==='devoirsprof'){
      ...
      // car il est aussi appelé au retour d'un test Objectif Nombre, où le brouillon doit survivre.
...
const CHANGELOG_DATA = [
  ...
  { version:'2026-08-19.681', items:[
    "Page d'accueil -- demandé : \"La page d'accueil avec les nouveautés en insérant les vidéos (attention un lien pour ne pas trop prendre sur supabase)\". Nouvelle section « Nouveautés en vidéo » : constructions animées aux instruments, mode apprentissage, Automatismes et Objectif Nombre en devoir, cours personnalisables. Les vidéos (720p, 1 à 3 Mo) sont servies par le site lui-même, pas par Supabase, et ne se chargent qu'au clic sur lecture (seule une image d'aperçu est affichée avant).",
  ...
  { version:'2026-08-19.680', items:[
    "Résultats des devoirs -- demandé : \"voir le nombre de tentatives des élèves et le temps passé réellement dessus\". Automatismes et Objectif Nombre : pour chaque séquence ou compte, nombre de tentatives (dont abandonnées) et temps de travail réel ; en tête de chaque élève, le total. Figures (à construire ou à compléter) : nombre de séances de travail, temps réel et nombre d'enregistrements. Colonnes Tentatives, Abandons et Temps de travail ajoutées à l'export CSV.",
    "Temps de travail réel : le chrono ne compte que si l'onglet est visible et l'activité à l'écran ; il s'arrête après 1 minute sans aucune action pour les automatismes, mais seulement après 5 minutes pour Objectif Nombre et les figures -- précisé : \"L'élève peut être en pause une minute facilement sur un Objectif Nombre ! Il cherche, ce n'est pas facile.\" Une séquence ou un compte quitté sans être validé est compté comme tentative abandonnée. Pour les tentatives faites avant cette version, seule la durée brute est connue : elle est affichée avec « ≈ … (pauses comprises) ».",
  ...
  { version:'2026-08-19.668', items:[
    ...
    "Page d'accueil : titre et description pour Google, image d'aperçu pour les partages (LinkedIn, Facebook…), données structurées (site éducatif), liens vers les nouvelles pages dans le pied de page. Ajout de sitemap.xml (liste des pages, avec leur vraie date de modification) et robots.txt ; les liens d'invitation personnels sont exclus des moteurs de recherche.",
  ]},
  { version:'2026-08-19.667', items:[
    "Import en masse d'élèves -- demandé : \"pour un référent, il faudrait importer : NOM, Prénom, Classe, identifiant, (mot de passe optionnel). Plus besoin de l'UAI qui est par défaut. Attention, comment se gèrent les identifiants si il y a des homonymes ?\". Nouveau format : NOM · Prénom · Classe · identifiant (facultatif) · mot de passe (facultatif), en copier-coller depuis un tableur ou séparé par « ; » (ligne d'en-tête ignorée). Le référent n'a plus de colonne UAI (son établissement est pris d'office) ; l'administrateur ajoute l'UAI en 6e colonne.",
    "Identifiant vide : fabriqué automatiquement sur le modèle des comptes existants (p.nom, ex. e.viard). Homonymes : l'identifiant étant unique sur tout le site, s'il est déjà pris (dans l'établissement, ailleurs sur le site ou plus haut dans la liste), un chiffre est ajouté (e.viard2, e.viard3…). Un élève de même nom et prénom déjà inscrit dans l'établissement est reconnu (ré-importation : simplement rattaché à la classe, sans doublon), avec une case « c'est un autre élève (homonyme) » pour créer quand même un nouveau compte.",
    "Nouvelle étape « Vérifier la liste » : avant toute création, un tableau montre pour chaque ligne l'identifiant retenu, les ajustements pour homonymie (et avec qui), les élèves déjà inscrits et les lignes en erreur (nom/prénom manquant, mot de passe de moins de 6 caractères…). Après création : tableau des identifiants, mots de passe et liens d'invitation à distribuer, téléchargeable pour un tableur.",
  ]},
  ...
  { version:'2026-08-19.625', items:[
    "Fix -- signalé : \"en mode reprendre, il est écrit pour l'élève qu'il n'est plus en compétition alors que finalement il pourrait le redevenir\". Le message \"Hors compétition\" affiché à l'élève sur un devoir \"à reprendre\" (Automatismes et Objectif Nombre) précise désormais que c'est temporaire, et explique comment redevenir éligible à une médaille (retravailler et renvoyer le devoir) -- au lieu de la formulation définitive partagée avec le cas \"en retard\".",
  ]},
  ...
  { version:'2026-08-19.609', items:[
    "Devoirs, modale \"Voir les rendus\" (prof) -- signalé : \"indiquer le statut du devoir de l'élève (en cours ou rendu, retard)\". Une pastille colorée apparaît à côté de chaque élève : Rendu (vert), En retard (magenta -- date limite dépassée et pas encore rendu), ou En cours (bleu). S'applique aux 3 types de devoirs (fichier/figure, automatismes, Objectif Nombre) et à leur export CSV.",
  ]},
  { version:'2026-08-19.608', items:[
    "Devoirs élève (Automatismes / Objectif Nombre), refonte suite à un test réel : \"je ne sais pas si mes résultats sont transmis... comment je rends mon travail ?\". Chaque séquence/compte affiche désormais son score en %, coloré comme dans la vue du professeur, avec une barre de réussite globale pour le devoir.",
  ...
  { version:'2026-08-19.600', items:[
    "Automatismes, esthétique -- signalé : \"un pavé numérique un peu plus gros\" et \"rendre la fenêtre plus sexy, un peu comme Objectif Nombre\". La fenêtre d'exercice (question et résultat) reprend désormais une carte dégradée colorée, comme pour Objectif Nombre, teintée selon le thème de la séquence (additions, tables, divisions, pourcentages, décimaux). Le pavé numérique tactile est nettement agrandi (boutons 72×64 px au lieu de 54×46) avec un relief 3D.",
  ]},
  ...
  { version:'2026-08-19.597', items:[
    "Devoirs, bouton Tester -- signalé : \"même principe pour la création des autres devoirs (automatismes...), pouvoir tester et revenir au menu quand on valide ou annule\". Le test d'une séquence d'Automatismes affiche désormais, comme pour Objectif Nombre, un bouton \"Retour à la création du devoir\" -- présent dès le début du test et qui reste après avoir cliqué \"Corriger\", pour revenir en un clic au formulaire (brouillon conservé) qu'on valide ou qu'on veuille simplement quitter.",
  ]},
  { version:'2026-08-19.596', items:[
    "Devoirs, Objectif Nombre -- signalé : \"il faudrait que je puisse les valider ou les regénérer un par un car certains sont trop difficiles\". Chaque compte du devoir est maintenant listé individuellement avec ses propres boutons \"Tester\" (joue exactement ce tirage) et \"Régénérer\" (retire un nouveau tirage pour ce compte seulement, sans toucher aux autres) -- une coche verte indique les comptes déjà testés. Changer le nombre de \"grands nombres\" régénère l'ensemble des comptes (la difficulté change pour tous) ; changer le nombre de comptes à jouer ajoute ou retire des tirages sans toucher à ceux déjà en place.",
  ]},
  ...
  { version:'2026-08-19.592', items:[
    ...
    "Devoirs : un devoir déjà créé peut désormais être modifié (bouton \"Éditer\") -- même formulaire que la création, avec conservation des tirages Objectif Nombre déjà joués si le nombre de comptes et la difficulté ne changent pas. Nouveau champ \"Date de dépôt\" : si elle est fixée dans le futur, le devoir reste invisible aux élèves jusqu'à cette date (publication programmée), en plus de la date limite existante.",
  ]},
  { version:'2026-08-19.591', items:[
    "Devoirs (prof), présentation -- signalé : \"c'est pas terrible... différencier les zones de création et de devoir créés, ajouter des couleurs\". Sur la page Devoirs : liseré bleu pour la zone \"Nouveau devoir\", vert pour \"Devoirs assignés\" ; chaque type d'activité (fichier, figure, figure à compléter, automatismes, Objectif Nombre) a sa propre couleur, reprise sur le sélecteur de type et sur chaque ligne de la liste (mêmes couleurs que les groupes d'Automatismes, pour rester cohérent). Même traitement pour l'onglet Devoirs de Supervision (Permis Rapporteur en bleu, Devoirs en orange). Nouveau : bouton \"Supprimer\" pour une session de Permis Rapporteur (jusqu'ici seule la clôture était possible).",
  ]},
  { version:'2026-08-19.590', items:[
    "Devoirs : deux évolutions suite à un échange sur Objectif Nombre. 1) Objectif Nombre : le prof peut désormais assigner plusieurs comptes dans un même devoir (1 à 5) -- le tirage de chaque compte est fixé à la création et servi identique à tous les élèves concernés (avant : un tirage aléatoire différent à chaque tentative). Le devoir est rendu une fois tous les comptes joués. 2) Tous les types de devoirs (fichier, figure, figure à compléter, automatismes, Objectif Nombre) peuvent désormais être assignés soit à toute la classe (comme avant), soit à une sélection d'élèves de la classe -- signalé : \"permettre d'assigner à la classe ou quelques élèves de la classe\".",
  ]},
  { version:'2026-08-19.589', items:[
    "Devoirs : un devoir peut désormais porter sur une figure de géométrie dynamique à compléter, une ou plusieurs séquences d'Automatismes, ou un défi Objectif Nombre avec la difficulté choisie par le prof (en plus du fichier ou de la figure libre à rendre, déjà existants) -- un seul type par devoir. Pour \"Figure à compléter\", le prof construit la figure de départ avec l'outil habituel ; l'élève la reprend et la complète. Pour Automatismes, le devoir est considéré fait quand toutes les séquences assignées ont été tentées au moins une fois ; pour Objectif Nombre, dès la première tentative jouée avec les réglages du prof (le tirage reste toujours garanti réalisable et tiré au hasard). Le suivi des rendus (\"Voir les rendus\") affiche le détail adapté à chaque type.",
  ]},
  ...
  { version:'2026-08-19.572', items:[
    "Administration -- nouveau : bouton \"Supprimer cette classe\" (n'existait pas jusqu'ici, signalé : \"comment un administrateur peut-il supprimer des classes ?\"). Refusée avec un message explicite tant que la classe a le moindre historique (sessions/résultats de Permis Rapporteur, résultats d'Objectif Nombre ou d'automatismes, devoirs, entrées de cahier) -- l'historique d'une classe déjà utilisée n'est jamais effacé silencieusement.",
  ]},
  ...
  { version:'2026-08-19.498', items:[
    "Supervision : les listes de comptes et de résultats (automatismes, Objectif Nombre) passent en vrais tableaux alignés, avec les scores en pastilles colorées selon la réussite.",
  ]},
  ...
  { version:'2026-08-04.36', items:[
    "Nouveau module Objectif Nombre : tirages garantis réalisables, mode chronométré optionnel, enregistrement des tentatives des élèves et statistiques de réussite visibles en Supervision.",
  ]},
  ...
  { version:'2026-08-04.35', items:[
    "Supervision -- ajout d'une section « <span class=gicon>casino</span> Objectif Nombre » : pour chaque élève de la classe active, le taux de réussite en mode illimité et en mode chronométré, ainsi que les 5 dernières tentatives (exact ou à combien près, mode, date).",
  ]},
  { version:'2026-08-04.34', items:[
    "Objectif Nombre -- les tentatives des élèves sont désormais enregistrées (nouvelle table Supabase ceb_results, mêmes règles de visibilité que les Automatismes : l'élève, son professeur, ou un administrateur). Un encart « Tes statistiques » affiche le nombre de tentatives et le taux de réussite, séparément en mode illimité et en mode chronométré, visible sur l'écran de réglages et après chaque partie.",
  ]},
  { version:'2026-08-04.33', items:[
    "Objectif Nombre -- deux améliorations : un journal des étapes reste affiché en permanence (pendant la partie et sur l'écran de résultat), rien ne disparaît visuellement. L'expression finale utilise désormais un parenthésage minimal (comme un calcul écrit à la main), au lieu de parenthéser systématiquement chaque étape : vérifié mathématiquement sur 200 tirages générés, tous corrects.",
  ]},
  { version:'2026-08-04.32', items:[
    "Nouveau module « Objectif Nombre » (accessible depuis le menu et la page d'accueil) : tirage de 6 nombres (petits 1-10, grands 25/50/75/100 en quantité réglable) et un compte entre 100 et 999, systématiquement vérifié réalisable exactement par un solveur avant d'être proposé. Chronomètre optionnel (30 s / 1 min / 1 min 30 / illimité). Le joueur combine les nombres deux par deux ; à la validation, le calcul est reconstitué automatiquement en une seule expression mathématique, comparée au compte, avec possibilité d'afficher une solution.",
  ]},
...
/* Export du tableau Objectif Nombre -- même principe, sur l'ensemble des tentatives de la classe
...
function exportSupervisionCebCsv(){
  ...
  downloadCsv(`resultats-objectif-nombre-${new Date().toISOString().slice(0,10)}.csv`, ['Élève','Cible','Réussi','Écart','Résultat obtenu','Mode','Date'], rows);
}
...
const TB_REQ2_L = 469, TB_REQ2_W = 138;
...
const TB_DEFS = {
  ...
  requerre2:   { rotateHandle:{x:TB_REQ2_L-20,y:TB_REQ2_W-6,r:7,opacity:0.5}, svg: requerre2SVG,
                 // Échelle calée EXACTEMENT sur 22px/cm (celle de la règle normale, TB_RULER_L),
                 // confirmé par une mesure directe et sans ambiguïté : distance entre le "0"
                 // (repéré par la colonne la plus sombre de l'image, x=382 dans la photo
                 // recadrée) et le bord droit correspondant à "+10" (x=742) = 360px pour 10cm
                 // sur la photo source, à redimensionner par 22/36 pour retomber sur 220px
                 // (=10x22) une fois à l'échelle -- vérifié après coup : exactement 220.00px.
                 // (Un premier calcul, basé sur un simple comptage de graduations, avait cru
                 // à tort mesurer 18px/cm alors qu'il s'agissait de demi-centimètres, d'où un
                 // premier correctif erroné x2 trop grand, corrigé ici.)
                 // Un recadrage initial trop large avait aussi été corrigé au passage (des
                 // pixels isolés/parasites dans le détourage avaient élargi la boîte englobante
                 // bien au-delà du corps réel de la règle -- recadrage refait en ne gardant que
                 // le plus grand composant connexe du détourage).
                 // Repères (mesurés sur la photo recadrée, facteur 22/36 appliqué) : bord du
                 // haut y=4 (6px source), bord du bas y=133 (218px source), traversant x=233
                 // (382px source, quasi le milieu), ligne centrale y=69 (113px source, quasi
                 // exactement le centre géométrique).
                 ...
                 edges: [
                   {x1:6,y1:4,x2:TB_REQ2_L-6,y2:4},
                   {x1:233,y1:-6,x2:233,y2:144},
                   {x1:6,y1:133,x2:TB_REQ2_L-6,y2:133},
                   {x1:6,y1:69,x2:TB_REQ2_L-6,y2:69},
                 ] },
...
const TB_HELP_TEXT = {
  ...
  requerre2: "<b>Réquerre</b>, une règle graduée avec un « traversant » (trait perpendiculaire au milieu, pour une perpendiculaire) et une ligne centrale (parallèle au bord principal, pour une parallèle). Approchez l'un des deux d'un trait déjà tracé pour faire apparaître un bouton <span class=gicon>link</span> qui l'aimante dessus, puis coulissez -- le long du trait pour le traversant, perpendiculairement pour la ligne centrale -- jusqu'à la position voulue, et tracez avec le crayon le long du bord principal ou du bord opposé (comme avec la règle).",
...
/* Même principe que tbFindSlideContact, mais pour la nouvelle réquerre : un de ses bords
   internes (traversant, edges[1] ; ou ligne centrale, edges[3]) doit s'aimanter non pas sur
   un autre outil, mais sur un trait DÉJÀ TRACÉ au crayon (tbInk). On approxime la droite du
   trait par ses deux points extrêmes (premier et dernier) -- suffisant pour un trait de
   construction, qui est déjà sensé être droit. Généralisé sur l'index du bord (edgeIdx) pour
   servir aux deux mécaniques (traversant = coulisser LE LONG de la droite ; ligne centrale =
   coulisser PERPENDICULAIREMENT, pour tracer une parallèle) sans dupliquer cette fonction. */
function tbFindRequerreInkContact(edgeIdx){
  const reqs = tbTools.filter(t=>t.type==='requerre2');
  let best=null, bestScore=Infinity;
  for(const req of reqs){
    const def = TB_DEFS[req.type];
    const te = def.edges[edgeIdx];
    ...
    for(const s of tbInk){
      ...
      bestScore = score;
      best = {tool:req, strokeId:s.id, edgeIdx, contactX: tax+tux*contactT, contactY: tay+tuy*contactT};
    }
  }
  return best;
}
...
function tbRender(){
  ...
  // Même principe pour la nouvelle réquerre : bouton affiché quand un de ses bords internes
  // touche un trait déjà tracé -- le traversant (edgeIdx=1, pour construire une
  // perpendiculaire, coulisse LE LONG de la droite) ou la ligne centrale (edgeIdx=3, pour
  // construire une parallèle, coulisse PERPENDICULAIREMENT à la droite). Les deux boutons
  ...
  [{edgeIdx:1, label:'Coulisser'}, {edgeIdx:3, label:'Parallèle'}].forEach(({edgeIdx, label})=>{
    ...
    if(reqContact){
      ...
      reqSlideLockHtml += `<g data-role="requerreSlideLockBtn" data-tool="${reqContact.tool.id}" data-stroke="${reqContact.strokeId}" data-edge="${edgeIdx}" transform="translate(${reqContact.contactX.toFixed(1)},${(reqContact.contactY-16).toFixed(1)})" style="cursor:pointer;">
        <rect x="-42" y="-12" width="84" height="24" rx="12" fill="${already?'#1F7A4D':'#0D5BA3'}" stroke="#fff" stroke-width="1.4"/>
        <text x="0" y="5" font-size="11" text-anchor="middle" fill="#fff" font-weight="700">${already?'✓ Verrouillé':`<tspan font-family="'Material Symbols Outlined'">link</tspan> ${label}`}</text>
      </g>`;
    } else {
      const lockedReq = tbTools.find(t=>t.type==='requerre2' && t.slideLock && t.slideLock.targetStrokeId!==undefined && t.slideLock.edgeIdx===edgeIdx);
      if(lockedReq){
        reqSlideLockHtml += `<g data-role="requerreSlideLockBtn" data-tool="${lockedReq.id}" data-stroke="${lockedReq.slideLock.targetStrokeId}" data-edge="${edgeIdx}" transform="translate(${lockedReq.x.toFixed(1)},${(lockedReq.y-24).toFixed(1)})" style="cursor:pointer;">
          <rect x="-42" y="-12" width="84" height="24" rx="12" fill="#1F7A4D" stroke="#fff" stroke-width="1.4"/>
          <text x="0" y="5" font-size="11" text-anchor="middle" fill="#fff" font-weight="700">✓ Verrouillé</text>
        </g>`;
      }
...
function tbAttachHandlers(){
  ...
  svg.onpointerdown = (e)=>{
    ...
    if(role==='requerreSlideLockBtn'){
      ...
      const toolId = parseInt(target.dataset.tool), strokeId = parseInt(target.dataset.stroke), edgeIdx = parseInt(target.dataset.edge);
      const req = tbTools.find(x=>x.id===toolId);
      if(req){
        const already = req.slideLock && req.slideLock.targetStrokeId===strokeId && req.slideLock.edgeIdx===edgeIdx;
        if(already){
          req.slideLock = null;
        } else {
          const stroke = tbInk.find(s=>s.id===strokeId);
          if(stroke && stroke.points.length>=2){
            const def = TB_DEFS[req.type], te = def.edges[edgeIdx];
            const [ax,ay] = stroke.points[0], [bx,by] = stroke.points[stroke.points.length-1];
            tbAlignEdgeToLine(req, te, ax, ay, bx, by);
          }
          // dirAngle reste toujours "angle + 90" quel que soit le bord aligné : le traversant
          // (perpendiculaire au bord principal) fait coïncider angle+90 avec la droite du
          // trait -- on glisse donc LE LONG d'elle ; la ligne centrale (parallèle au bord
          // principal) fait coïncider angle directement avec la droite -- angle+90 glisse
          // alors PERPENDICULAIREMENT à elle, exactement ce qu'il faut pour tracer une
          // parallèle à distance réglable.
          req.slideLock = {targetStrokeId: strokeId, edgeIdx, dirAngle: req.angle + 90};
        }
        tbRender();
      }
      return;
